...
const FormProvider = ({ children }) => {
    const [ manageFormParams, setManageFormParams ] = useState({ datatype: null })
    ...
    return (
        <FormContext.Provider value={{ manageFormParams, openManageForm, closeManageForm, formModalId }}>
            {children}
