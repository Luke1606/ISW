...
import { getAllData, getAllSubData, getData, deleteData } from "../../../API"
...
const List = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            if(id!=0)
                response = await getAllSubData(datatype, id)
            else
                response = await getAllData(datatype)    
        } catch (error) {
            console.log(error)
        }finally{   
                                    ...
                                    {itemGroup.map((item) => (
                                        <li style={styles.li} key={item.id}>
                                            ...
                                            <div style={styles.buttonGroup}>
                                                ...
                                                { datatype=='estudiante' && <BaseButton onClick={() => {setShowMoreOptions(true)}}>Opciones</BaseButton> }
                                                { datatype=='estudiante' && showMoreOptions && 
