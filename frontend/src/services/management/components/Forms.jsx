...
const DataForm = () => {
    ...
    switch (dataType) {
        case "evidencia":
            children = <EvidenceForm formik={formik} readOnly={readOnly}/>
            break 
        case "solicitud":
            children = <RequestForm formik={formik} readOnly={readOnly}/>
            break
        case "defensa-tribunal":    
            children = <DefenseTribunalForm formik={formik} readOnly={readOnly}/>
            break
        case "tribunal":
            children = <TribunalAprovalForm formik={formik}/>
            break
        case "acta defensa":    
            children = <DefenseActForm formik={formik} readOnly={readOnly}/>
            break
        case "usuario":    
            children = <UserForm formik={formik} readOnly={readOnly}/>
            break
    }
    return (
...
const RequestForm = (idData=0, readOnly) => {
    let prevValues = {}
    if (idData != 0) prevValues = fetchPrevValues(idData)
...
// eslint-disable-next-line no-unused-vars
const DefenseTribunalForm = (idData=0, readOnly) => {
    let prevValues = {}
    if (idData != 0) prevValues = fetchPrevValues(idData)
...
// eslint-disable-next-line no-unused-vars
const TribunalAprovalForm = (idData, readOnly) => {
...
// eslint-disable-next-line no-unused-vars
const DefenseActForm = (idData=0, readOnly) => {
    let prevValues = {}
    if (idData != 0) prevValues = fetchPrevValues(idData)
...
// eslint-disable-next-line no-unused-vars
const UserForm = (idData=0, readOnly) => {
    let prevValues = {}
    if (idData != 0) prevValues = fetchPrevValues(idData)
